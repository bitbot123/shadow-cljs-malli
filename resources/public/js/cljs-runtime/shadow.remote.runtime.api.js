...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_30540 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_30540(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_30543 = (function (runtime,key,spec){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_30543(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_30548 = (function (runtime,key){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_30548(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_30558 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_30558(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_30565 = (function (runtime,input,callback){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_30565(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_30569 = (function (runtime,code){
var x__4509__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_30569(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__30504,callback){
var map__30505 = p__30504;
var map__30505__$1 = cljs.core.__destructure_map(map__30505);
var input = map__30505__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30505__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30505__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
