...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26672 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26672(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26676 = (function (port,val,fn1_handler){
var x__4509__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26676(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26677 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26677(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26678 = (function (chan){
var x__4509__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26678(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26679 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26679(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26681 = (function (h){
var x__4509__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26681(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_26684 = (function (h){
var x__4509__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_26684(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26686 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26686(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26687 = (function (b){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26687(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26688 = (function (b,itm){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26688(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26689 = (function (b){
var x__4509__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26689(b);
}
});
